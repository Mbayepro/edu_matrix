-- ============================================================
-- EDUMATRIX - MIGRATION V4 : SOUTIEN AUX BULLETINS DETAILLES SENEGALAIS (PRIMAIRE & MOYEN/SECONDAIRE)
-- JSON Aggregation pour plus de flexibilité dans le front
-- ============================================================

-- Nettoyage complet pour éviter l'erreur de changement de nom/ordre de colonne (Postgres 42P16)
...
-- 1. Vue pour les moyennes par matière (export de l'historique complet mcc + compo + est_bonus)
...
-- 2. Vue pour les moyennes générales (Identique à v3 pour conserver le flux PostgreSQL)
...
-- 3. Vue des bulletins complets avec agrégation de JSON natif
